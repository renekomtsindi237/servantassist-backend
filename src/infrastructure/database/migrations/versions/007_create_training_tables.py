...
def upgrade() -> None:
    ...
    "duration_minutes > 0",
     name="check_duration_positive"),
        sa.CheckConstraint(
    "max_participants >= 0",
     name="check_max_participants_positive"),
    )
    ...
    "training_sessions",
     ["status"])
    op.create_index(
    "idx_training_sessions_trainer",
    "training_sessions",
     ["trainer_id"])
    op.create_index(
    "idx_training_sessions_created_by",
    "training_sessions",
     ["created_by"])
    ...
    "session_id",
    "servant_id",
     name="uq_session_servant"),
    )

    # Index pour améliorer les performances
    op.create_index(
    "idx_training_participations_session",
    "training_participations",
     ["session_id"])
    op.create_index(
    "idx_training_participations_servant",
    "training_participations",
     ["servant_id"])
    op.create_index("idx_training_participations_status",
                    "training_participations", ["status"])
    ...
    # Index pour améliorer les performances
    op.create_index(
    "idx_training_materials_type",
    "training_materials",
     ["type"])
    op.create_index(
    "idx_training_materials_level",
    "training_materials",
     ["level"])
    op.create_index(
    "idx_training_materials_public",
    "training_materials",
     ["is_public"])
    op.create_index(
    "idx_training_materials_uploaded_by",
    "training_materials",
     ["uploaded_by"])
    ...
    "session_id",
    "material_id",
     name="uq_session_material"),
    )

    # Index pour améliorer les performances
    op.create_index(
    "idx_session_materials_session",
    "session_materials",
     ["session_id"])
    op.create_index(
    "idx_session_materials_material",
    "session_materials",
     ["material_id"])
