...
def upgrade() -> None:
    ...
    op.create_index(
    "ix_financial_entries_recorded_by",
    "financial_entries",
     ["recorded_by"])
    op.create_index(
    "ix_financial_entries_verified_by",
    "financial_entries",
     ["verified_by"])
    op.create_index(
    "ix_financial_entries_created_at",
    "financial_entries",
     ["created_at"])
