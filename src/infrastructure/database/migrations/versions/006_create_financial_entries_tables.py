...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('verification_status', sa.String(50), nullable=False, server_default='EN_ATTENTE'),
        sa.Column('verification_date', sa.DateTime(), nullable=True),
        sa.Column('notes', sa.Text(), nullable=True),
        sa.Column('watermark_logo', sa.String(255), nullable=False, server_default='logo_servant.jpeg'),
    ...
    op.create_index('ix_financial_entries_verification_status', 'financial_entries', ['verification_status'])
