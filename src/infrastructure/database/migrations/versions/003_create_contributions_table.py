...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('week_number', sa.Integer, nullable=True),  # 1-4 for weekly payments
        ...
        sa.CheckConstraint('week_number IS NULL OR (week_number >= 1 AND week_number <= 4)', name='check_week_number_valid'),
        sa.CheckConstraint(
