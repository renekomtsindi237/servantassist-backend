...
def upgrade() -> None:
    ...
    op.create_index(
    "idx_sport_culture_events_type",
    "sport_culture_events",
     ["event_type"])
    op.create_index(
    "idx_sport_culture_events_status",
    "sport_culture_events",
     ["status"])
    op.create_index(
    "idx_sport_culture_events_date",
    "sport_culture_events",
     ["date"])
    op.create_index(
    "idx_sport_culture_events_created_by",
    "sport_culture_events",
     ["created_by"])
    ...
    # Index pour améliorer les performances
    op.create_index(
    "idx_event_participations_event",
    "event_participations",
     ["event_id"])
    op.create_index(
    "idx_event_participations_servant",
    "event_participations",
     ["servant_id"])
    op.create_index(
    "idx_event_participations_status",
    "event_participations",
     ["status"])
    ...
    ["users.id"],
     ondelete="CASCADE"),
        ...
        sa.CheckConstraint(
    "opponent_score >= 0",
     name="check_opponent_score_positive"),
