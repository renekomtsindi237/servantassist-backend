...
def downgrade() -> None:
    op.drop_index(op.f('ix_weekly_schedule_modification_logs_modified_at'), table_name='weekly_schedule_modification_logs')
    op.drop_index(op.f('ix_weekly_schedule_modification_logs_modified_by'), table_name='weekly_schedule_modification_logs')
    op.drop_index(op.f('ix_weekly_schedule_modification_logs_template_id'), table_name='weekly_schedule_modification_logs')
    op.drop_table('weekly_schedule_modification_logs')
    op.drop_index(op.f('ix_slot_servant_assignments_servant_id'), table_name='slot_servant_assignments')
    op.drop_index(op.f('ix_slot_servant_assignments_slot_id'), table_name='slot_servant_assignments')
    ...
    op.drop_index(op.f('ix_weekly_schedule_templates_status'), table_name='weekly_schedule_templates')
    op.drop_index(op.f('ix_weekly_schedule_templates_start_date'), table_name='weekly_schedule_templates')
