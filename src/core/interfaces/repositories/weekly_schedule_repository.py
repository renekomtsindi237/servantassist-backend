...
class IWeeklyScheduleRepository(Protocol):
    ...
    async def update_template(self, template_id: UUID, **kwargs) -> Optional[WeeklyScheduleTemplate]: ...
    async def delete_template(self, template_id: UUID) -> bool: ...
    async def list_templates(self, *, page: int = 1, page_size: int = 20, **filters) -> Tuple[List[WeeklyScheduleTemplate], int]: ...
    ...
    async def update_slot(self, slot_id: UUID, **kwargs) -> Optional[WeeklyScheduleSlot]: ...
