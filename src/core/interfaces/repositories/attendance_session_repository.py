...
class IAttendanceSessionRepository(Protocol):
    ...
    async def list_sessions(self, *, page: int = 1, page_size: int = 20, **filters) -> Tuple[List[AttendanceSession], int]: ...
    ...
    async def get_servant_records(self, servant_id: UUID, **filters) -> List[AttendanceRecord]: ...
    async def update_record(self, record_id: UUID, **kwargs) -> Optional[AttendanceRecord]: ...
