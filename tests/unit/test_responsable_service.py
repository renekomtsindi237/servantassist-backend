...
from src.core.entities.council_meeting import CouncilMeeting, CouncilAttendance, CouncilAttendanceStatus
from src.presentation.schemas.responsable import CouncilMeetingCreate, CouncilAttendanceRecordList, CouncilAttendanceRecord
